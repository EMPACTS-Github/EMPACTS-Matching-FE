...
const FormedTimeSection: React.FC<FormedTimeSectionProps> = ({
  ...
  const calendarDate = formedTime
    ? new CalendarDate(formedTime.getFullYear(), formedTime.getMonth() + 1, formedTime.getDate())
    : null;
  ...
  return (
    <div className="flex flex-col w-full gap-2">
      <label className="text-[14px] font-semibold text-[#09090b]">Date established</label>
      <DatePicker
        isRequired
        variant="bordered"
        className="w-full"
