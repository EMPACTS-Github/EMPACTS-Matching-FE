...
const RoleChip = ({ role }: { role: string }) => (
  <Chip
    ...
    className={
      role === 'OWNER' ? 'border-empacts border-1 bg-empacts-lighter capitalize' : 'border-1'
    }
  >
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="space-x-2">
          ...
          <Button
            ...
            color="primary"
            className={
              filterMode === 'OWNER' ? 'font-bold' : 'border-empacts-grey-50 border-1 font-bold'
            }
          ...
          <Button
            ...
            color="primary"
            className={
              filterMode === 'MEMBER' ? 'font-bold' : 'border-empacts-grey-50 border-1 font-bold'
            }
        ...
        {acessAction.canInvite && (
          <Button className="bg-empacts text-white px-4" size="sm" onPress={onInviteOpen}>
            INVITE
          </Button>
        )}
      </div>
