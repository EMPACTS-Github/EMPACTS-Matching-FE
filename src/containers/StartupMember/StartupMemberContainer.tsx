    ...
    <div className="flex w-full 2xl:px-[20%] xl:px-56 lg:px-48 md:px-32 sm:px-16 xs:px-8 px-4 relative z-10 gap-0 mt-6">
      {startup_profile?.startup ? (
        <div className="w-[75%] mx-0 flex flex-col">
          <MemberListContainer
            members={startup_profile.members}
        ...
        <div className="w-[75%] mx-0 flex flex-col">
          <div className="flex justify-between items-center mb-4">
            <div className="space-x-2">
              <Button size="sm" variant="solid" color="primary" radius="full" isDisabled={false}>
                All
              </Button>
              <Button
                size="sm"
            ...
            <Button className="bg-empacts text-white px-4" size="sm">
              INVITE
            </Button>
          </div>
