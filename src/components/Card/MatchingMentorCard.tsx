...
const MatchingMentorCard: React.FC<MatchingMentorCardProps> = ({
  ...
  return (
    <Card
      fullWidth
      isPressable
      className="flex flex-row gap-2 rounded-md px-4 py-4 items-center shadow-sm"
      onPress={onCardClick}
    >
      <div className="w-[25%]">
        <Avatar
      ...
      <div className="flex flex-col justify-start w-[75%]">
        ...
        <div className="flex gap-2 items-center mt-2">
          ...
          <div
            className={`font-semibold ${status === MATCHING_STATUS.ACCEPTED ? 'text-success' : 'text-gray-500'}`}
          >
