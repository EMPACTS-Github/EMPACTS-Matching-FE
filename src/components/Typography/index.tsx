...
const Typography = ({ type = 'p', variant = 'body-28-bold', customStyle = {}, children, className, ...props }: TypographyProps) => {
  const allowedTags: TypographyTag[] = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'small'];
  const Tag: TypographyTag = allowedTags.includes(type as TypographyTag) ? (type as TypographyTag) : 'p';
