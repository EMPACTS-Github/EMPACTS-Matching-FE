...
import { Input, Button, ModalBody, Modal, ModalContent, ModalHeader, ModalFooter } from "@heroui/react";
...
const InviteMemberModal: React.FC<InviteMemberModalProps> = ({ isOpen, onOpenChange, members, onInvite, setMembers }) => {
                        ...
                        <ModalHeader className="items-center ">
                            <div className="flex">
                                <div>
                                    ...
                                    <div className="font-normal text-gray-400 text-sm">Invite member into your interesting journey!</div>
                                </div>
                            </div>
                        </ModalHeader>
                        <ModalBody>
