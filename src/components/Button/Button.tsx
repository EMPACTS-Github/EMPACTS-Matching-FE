...
export const buttonPresets = {
  ...
  "primary-lg-fullwidth": {
    className:
      "bg-primary text-white hover:bg-primary-80 active:bg-primary-100 w-full",
    size: "lg" as const,
    fullWidth: true,
    radius: "lg" as const,
  },
  "primary-lg": {
    className:
      "bg-primary text-white hover:bg-primary-80 active:bg-primary-100",
    size: "lg" as const,
    fullWidth: false,
    radius: "lg" as const,
  },
  ...
  "primary-sm": {
    className:
      "bg-primary text-white hover:bg-primary-80 active:bg-primary-100 text-sm",
    size: "sm" as const,
    fullWidth: false,
    radius: "lg" as const,
  },
  ...
  "submit-sm": {
    className:
      "bg-primary text-white text-sm hover:bg-primary-80 active:bg-primary-100",
    size: "sm" as const,
    fullWidth: false,
    radius: "lg" as const,
    type: "submit" as const, // Default type for submit buttons
  ...
  "secondary-lg": {
    className:
      "border-2 border-primary text-primary hover:bg-primary-20 active:bg-primary-40",
    size: "lg" as const,
    fullWidth: true,
    radius: "lg" as const,
  },
  ...
  "light-lg": {
    className:
      "bg-primary-20 text-primary hover:bg-primary-40 active:bg-primary-80",
    size: "lg" as const,
    fullWidth: true,
    radius: "lg" as const,
  },
  ...
  "light-sm": {
    className:
      "bg-primary-20 text-primary hover:bg-primary-40 active:bg-primary-80 text-sm",
    size: "sm" as const,
    fullWidth: false,
    radius: "lg" as const,
  },
  ...
  google: {
    className:
      "w-full mt-2 flex justify-center items-center bg-[#F4F4F4] text-black",
    size: "lg" as const,
    fullWidth: true,
    radius: "lg" as const,
  },
  ...
  "danger-sm": {
    className:
      "bg-red-600 text-white hover:bg-red-700 active:bg-red-800 text-sm",
    size: "sm" as const,
    fullWidth: false,
    radius: "lg" as const,
  },
  ...
  "success-sm": {
    className:
      "bg-green-600 text-white hover:bg-green-700 active:bg-green-800 text-sm",
    size: "sm" as const,
    fullWidth: false,
    radius: "lg" as const,
  },
